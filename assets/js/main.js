...
(function() {
    $(function() {
                    ...
                    $.ajax({
                        ...
                        success: function(response) {
                            setTimeout(function() {
                                ...
                                input_email.val('');
                                if (ui_elem.form_message.length)
                                    ui_elem.form_message.val('');
                                input_name.val('');
                            }, 3000);
                            setTimeout(function() {
        ...
        if (ui_elem.countdown_timer.length) {
            ...
            elem.countdown(st, function(event) {
                $(this).html(event.strftime('<span>' + '<span class="time">%D</span>' + '<br/>' + days + '</span><!--' + '--><span class="sep">:</span><!--' + '--><span>' + '<span class="time">%H</span>' + '<br/>' + hrs + '</span><!--' + '--><span class="sep">:</span><!--' + '--><span>' + '<span class="time">%M</span>' + '<br/>' + mins + '</span><!--' + '--><span class="sep">:</span><!--' + '--><span>' + '<span class="time">%S</span>' + '<br/>' + secs + '</span>'));
            });
        }
    });
    var interval = null
    ...
    function run_preloader() {
        ...
        interval = setInterval(function() {
            var len = p.children('span').length
              , i = 0;
            for (i; i < len; i++) {
    ...
    $.fn.stretch_text = function() {
        ...
        var one_line = $('<span class="stretch_it">' + txt + '</span>'), nb_char = elmt.text().length, spacing = cont_width / nb_char, txt_width;
        elmt.html(one_line);
